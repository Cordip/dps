...
public final class StructuredMotherRef extends StructuredRelationRef {
    public StructuredMotherRef() {
    }

    public StructuredMotherRef(StructuredPerson target, String provenance) {
